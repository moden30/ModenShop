                    ...
                    <div class="left-sidebar">
                            ...
                            <div class="layout-list">
                                <ul>
                                    @foreach($danh_mucs as $dm)
                                        <li><a href="#" value="{{ $dm->ten_danh_muc }}">{{ $dm->ten_danh_muc }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        ...
                        <div class="price-filter-area shop-layout">
                            <div class="price-filter">
                                ...
                                <form id="price-filter-form" action="{{ route('product.filter') }}" method="GET">
                                    <input type="hidden" id="min_price" name="min_price" value="0">
                                    <input type="hidden" id="max_price" name="max_price" value="10000000">
    ...
    <script>
        $(function() {
            $("#slider-range").slider({
                range: true,
                min: 0,
                max: 10000000, // Adjust max value according to your data
                values: [0, 10000000],
